...
import { CpfCnpjUtils } from "../CpfCnpjUtils/CpfCnpjUtils";
import { Constantes } from "../Constantes/Constantes";
import { FormatarTelefone } from "./Mascaras/formataTelefone";
...
export class FormatarEndereco {
    ...
    //    aux = "";
    //    if (enderecoEntrega.EndEtg_produtor_rural_status == Constantes.COD_ST_CLIENTE_PRODUTOR_RURAL_SIM) {
    //        if (enderecoEntrega.EndEtg_contribuinte_icms_status == Constantes.COD_ST_CLIENTE_CONTRIBUINTE_ICMS_NAO)
    //            aux = "Sim (Não contribuinte)";
    //        if (enderecoEntrega.EndEtg_contribuinte_icms_status == Constantes.COD_ST_CLIENTE_CONTRIBUINTE_ICMS_SIM)
    //            aux = "Sim (IE: " + enderecoEntrega.EndEtg_ie + ")";
    //        if (enderecoEntrega.EndEtg_contribuinte_icms_status == Constantes.COD_ST_CLIENTE_CONTRIBUINTE_ICMS_ISENTO)
    //            aux = "Sim (Isento)";
    //    }

    //    if (enderecoEntrega.EndEtg_produtor_rural_status == Constantes.COD_ST_CLIENTE_PRODUTOR_RURAL_NAO)
    //        aux = "Não";
