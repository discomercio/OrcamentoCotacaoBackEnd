...
namespace Loja.Bll.PedidoBll
{
    public class PedidoLogBll
    {
        ...
        //public async Task<string> PedidoLogInclusao(InfraBanco.ContextoBd contextoBd, string id_pedido_base, string apelido,
        //    Loja.Bll.PedidoBll.PedidoBll pedidoBll, string rb_forma_pagto, bool usar_rb_end_entrega,
        //    string operacao_origem, InfraBanco.ContextoBdProvider contextoBdProvider, string c_numero_magento,
