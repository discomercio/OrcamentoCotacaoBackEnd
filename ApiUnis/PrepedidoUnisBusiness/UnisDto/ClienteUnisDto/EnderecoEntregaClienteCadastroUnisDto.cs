...
namespace PrepedidoApiUnisBusiness.UnisDto.ClienteUnisDto
{
    public class EnderecoEntregaClienteCadastroUnisDto
    {
        ...
        public static Cliente.Dados.EnderecoEntregaClienteCadastroDados EnderecoEntregaClienteCadastroDadosDeEnderecoEntregaClienteCadastroUnisDto(EnderecoEntregaClienteCadastroUnisDto endEtg, bool outroEnd)
        {
