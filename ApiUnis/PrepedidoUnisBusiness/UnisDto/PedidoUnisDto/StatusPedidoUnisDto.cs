...
{
    public class StatusPedidoUnisDto
    {
        ...
        public static StatusPedidoUnisDto StatusPedidoUnisDto_De_StatusPedidoPedidoDados(StatusPedidoPedidoDados origem)
        {
            if (origem == null) return null;
            return new StatusPedidoUnisDto()
            {
