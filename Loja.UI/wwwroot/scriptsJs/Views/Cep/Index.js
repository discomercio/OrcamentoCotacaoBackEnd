$("#btnModificar").click(function () {
    ...
    $('.teste').children().find('input').filter(function () {
        if ($(_this).prop('checked') == true) {
            var elem = $(_this).parent().parent().parent();
...
function montaTabela(data) {
    ...
    if (lst.length > 0) {
        ...
        if ($('.tabela_endereco').css("display", "block"))
            $('.tabela_endereco').css("display", "none");
...
//# sourceMappingURL=/scriptsJs/Views/Cep/Index.js.map