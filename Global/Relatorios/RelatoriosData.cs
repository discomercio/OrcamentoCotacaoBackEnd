        ...
        public List<DadosOrcamentoDto> RelatorioDadosOrcamento(DadosOrcamentosFiltro obj)
        {
            ...
            using (var db = contexto.GetContextoLeitura())
            {
                ...
                using (var command = db.Database.GetDbConnection().CreateCommand())
                {
                    ...
                    //opcao1 tem que ser dinâmico
                    //devemos verificar a maior qtde de opções comparando entre o param de config e maior qtde de opções cadastrada para um orçamento
                    //se o param no banco for maior do que 
                    string opcoes = "";
                    for(int i = 0; i < qtdeMaxOpcoes; i++)
                    {
                        ...
                        $"([tOpcAux].[Sequencia] = 1)) AS [ComissaoOpcao{i + 1}],";
                        string descontoMedioAvistaOpcao = " (SELECT CASE WHEN (Coalesce(SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista]), 0) <> 0)" +
                            ...
                            " ([tPagAux].[tipo_parcelamento] = 1) AND ([tOpcAux].[Sequencia] = 1) AND ([tPagAux].[Id] IN " +
                        ...
                        string descontoMedioAprazoOpcao = " (SELECT CASE WHEN (Coalesce(SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista]), 0) <> 0) " +
                            ...
                            " AND ([tOpcAux].[Sequencia] = 1) AND ([tPagAux].[Id] IN (SELECT [tCustoFinAux2].[IdOpcaoPagto] FROM [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux2]" +
                        ...
                        string formaPagtoAVistaOpcao = "(SELECT [tMeioPagAux].[Descricao] FROM [dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux] INNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] " +
                            "ON [tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao] INNER JOIN [dbo].[t_CFG_PAGTO_MEIO] [tMeioPagAux] ON ([tMeioPagAux].[Id] = [tPagAux].[av_forma_pagto])" +
                            $" WHERE ([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id]) AND ([tPagAux].[Habilitado] = 1) AND ([tPagAux].[tipo_parcelamento] = 1) AND ([tOpcAux].[Sequencia] = 1)) AS [FormaPagtoAVistaOpcao{i + 1}],";
                        string valorFormaPagtoAVistaOpcao = "(SELECT SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoNF]) FROM [dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux] " +
                            ...
                            $"([tPagAux].[tipo_parcelamento] = 1) AND ([tOpcAux].[Sequencia] = 1)) AS [ValorFormaPagtoAVistaOpcao{i + 1}], ";
                        string statusDescSuperiorAVistaOpcao = "(SELECT CASE WHEN (SELECT TOP 1 [tPagAux].[Id] FROM [dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux] " +
                            ...
                            $"AND ([tOpcAux].[Sequencia] = 1) AND ([tAtomCustoFinAux].[StatusDescontoSuperior] <> 0)) IS NOT NULL THEN 'Sim' ELSE 'Não' END) AS [StatusDescSuperiorAVistaOpcao{i + 1}], ";
                        string formaPagtoAPrazoOpcao = "(SELECT [tFormaPagAux].[Descricao] FROM [dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux] " +
                            ...
                            "WHERE ([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id]) AND ([tPagAux].[Habilitado] = 1) AND ([tPagAux].[tipo_parcelamento] <> 1) AND ([tOpcAux].[Sequencia] = 1)) " +
                        ...
                        string valorFormaPagtoAPrazoOpcao = "(SELECT SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoNF]) FROM [dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux] " +
                            ...
                            $"AND ([tPagAux].[tipo_parcelamento] <> 1) AND ([tOpcAux].[Sequencia] = 1)) AS [ValorFormaPagtoAPrazoOpcao{i + 1}],";
                        string qtdeParcelasFormaPagtoAPrazoOpcao = "(SELECT CASE [tPagAux].[tipo_parcelamento] WHEN 5 THEN 1 WHEN 2 THEN [tPagAux].[pc_qtde_parcelas] WHEN 6 THEN [tPagAux].[pc_maquineta_qtde_parcelas] " +
                            ...
                            $"AND ([tPagAux].[tipo_parcelamento] <> 1) AND ([tOpcAux].[Sequencia] = 1)) AS [QtdeParcelasFormaPagtoAPrazoOpcao{i + 1}],";
                    ...
                    //fim da montagem de uma opção

                    //remover ComissaoOpcao2e3 pq devemos montar de forma dinamica
                    //string ComissaoOpcao2e3 = "(SELECT [tOpcAux].[PercRT] FROM [dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux] WHERE ([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id]) " +
                    //    "AND ([tOpcAux].[Sequencia] = 2)) AS [ComissaoOpcao2], (SELECT \r\n\t\t\tCASE\r\n\t\t\tWHEN (Coalesce(SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista]),\r\n\t\t\t0) <> 0) THEN\r\n\t\t\t\t(100 *((SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista]) - SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoNF])) / SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista])))\r\n\t\t\tELSE NULL\r\n\t\tEND\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_UNIFICADO] [tUnifAux] ON\r\n\t\t[tOpcAux].[Id] = [tUnifAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO] [tAtomAux] ON\r\n\t\t[tUnifAux].[Id] = [tAtomAux].[IdItemUnificado]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux] ON\r\n\t\t([tAtomAux].[Id] = [tCustoFinAux].[IdItemAtomico])\r\n\t\t\tAND ([tPagAux].[Id] = [tCustoFinAux].[IdOpcaoPagto])\r\n\t\tWHERE\r\n\t\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\t\tAND ([tPagAux].[tipo_parcelamento] = 1)\r\n\t\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 2)\r\n\t\t\t\t\t\t\tAND ([tPagAux].[Id] IN (\r\n\t\t\t\t\t\t\tSELECT\r\n\t\t\t\t\t\t\t\t[tCustoFinAux2].[IdOpcaoPagto]\r\n\t\t\t\t\t\t\tFROM\r\n\t\t\t\t\t\t\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux2]\r\n\t\t\t\t\t\t\tWHERE\r\n\t\t\t\t\t\t\t\t([tCustoFinAux2].[IdOpcaoPagto] = [tCustoFinAux].[IdOpcaoPagto])))\r\n\t) AS [DescMedioAVistaOpcao2]\r\n\t,\r\n\t(\r\n\tSELECT \r\n\t\t\tCASE\r\n\t\t\tWHEN (Coalesce(SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista]),\r\n\t\t\t0) <> 0) THEN\r\n\t\t\t\t(100 *((SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista]) - SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoNF])) / SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista])))\r\n\t\t\tELSE NULL\r\n\t\tEND\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_UNIFICADO] [tUnifAux] ON\r\n\t\t[tOpcAux].[Id] = [tUnifAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO] [tAtomAux] ON\r\n\t\t[tUnifAux].[Id] = [tAtomAux].[IdItemUnificado]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux] ON\r\n\t\t([tAtomAux].[Id] = [tCustoFinAux].[IdItemAtomico])\r\n\t\t\tAND ([tPagAux].[Id] = [tCustoFinAux].[IdOpcaoPagto])\r\n\t\tWHERE\r\n\t\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\t\tAND ([tPagAux].[tipo_parcelamento] <> 1)\r\n\t\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 2)\r\n\t\t\t\t\t\t\tAND ([tPagAux].[Id] IN (\r\n\t\t\t\t\t\t\tSELECT\r\n\t\t\t\t\t\t\t\t[tCustoFinAux2].[IdOpcaoPagto]\r\n\t\t\t\t\t\t\tFROM\r\n\t\t\t\t\t\t\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux2]\r\n\t\t\t\t\t\t\tWHERE\r\n\t\t\t\t\t\t\t\t([tCustoFinAux2].[IdOpcaoPagto] = [tCustoFinAux].[IdOpcaoPagto])))\r\n\t) AS [DescMedioAPrazoOpcao2]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\t[tMeioPagAux].[Descricao]\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_CFG_PAGTO_MEIO] [tMeioPagAux] ON\r\n\t\t([tMeioPagAux].[Id] = [tPagAux].[av_forma_pagto])\r\n\tWHERE\r\n\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\tAND ([tPagAux].[tipo_parcelamento] = 1)\r\n\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 2)\r\n\t) AS [FormaPagtoAVistaOpcao2]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\tSUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoNF])\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_UNIFICADO] [tUnifAux] ON\r\n\t\t[tOpcAux].[Id] = [tUnifAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO] [tAtomAux] ON\r\n\t\t[tUnifAux].[Id] = [tAtomAux].[IdItemUnificado]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux] ON\r\n\t\t([tAtomAux].[Id] = [tCustoFinAux].[IdItemAtomico])\r\n\t\t\tAND ([tPagAux].[Id] = [tCustoFinAux].[IdOpcaoPagto])\r\n\t\tWHERE\r\n\t\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\t\tAND ([tPagAux].[tipo_parcelamento] = 1)\r\n\t\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 2)\r\n\t) AS [ValorFormaPagtoAVistaOpcao2]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\tCASE\r\n\t\t\tWHEN (\r\n\t\t\tSELECT\r\n\t\t\t\tTOP 1 [tPagAux].[Id]\r\n\t\t\tFROM\r\n\t\t\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\t\t\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\t\t\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tAtomCustoFinAux] ON\r\n\t\t\t\t[tPagAux].[Id] = [tAtomCustoFinAux].[IdOpcaoPagto]\r\n\t\t\tWHERE\r\n\t\t\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\t\t\tAND ([tPagAux].[tipo_parcelamento] = 1)\r\n\t\t\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 2)\r\n\t\t\t\t\t\t\t\tAND ([tAtomCustoFinAux].[StatusDescontoSuperior] <> 0)\r\n\t\t\t\t) IS NOT NULL THEN 'Sim'\r\n\t\t\tELSE 'Não'\r\n\t\tEND\r\n\t) AS [StatusDescSuperiorAVistaOpcao2]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\t[tFormaPagAux].[Descricao]\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_CFG_PAGTO_FORMA] [tFormaPagAux] ON\r\n\t\t[tPagAux].[tipo_parcelamento] = [tFormaPagAux].[Id]\r\n\tWHERE\r\n\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\tAND ([tPagAux].[tipo_parcelamento] <> 1)\r\n\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 2)\r\n\t) AS [FormaPagtoAPrazoOpcao2]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\tSUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoNF])\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_UNIFICADO] [tUnifAux] ON\r\n\t\t[tOpcAux].[Id] = [tUnifAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO] [tAtomAux] ON\r\n\t\t[tUnifAux].[Id] = [tAtomAux].[IdItemUnificado]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux] ON\r\n\t\t([tAtomAux].[Id] = [tCustoFinAux].[IdItemAtomico])\r\n\t\t\tAND ([tPagAux].[Id] = [tCustoFinAux].[IdOpcaoPagto])\r\n\t\tWHERE\r\n\t\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\t\tAND ([tPagAux].[tipo_parcelamento] <> 1)\r\n\t\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 2)\r\n\t) AS [ValorFormaPagtoAPrazoOpcao2]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\tCASE\r\n\t\t\t[tPagAux].[tipo_parcelamento] WHEN 5 THEN 1\r\n\t\t\tWHEN 2 THEN [tPagAux].[pc_qtde_parcelas]\r\n\t\t\tWHEN 6 THEN [tPagAux].[pc_maquineta_qtde_parcelas]\r\n\t\t\tWHEN 3 THEN (1 + [tPagAux].[pce_prestacao_qtde])\r\n\t\t\tWHEN 4 THEN (1 + [tPagAux].[pse_demais_prest_qtde])\r\n\t\tEND\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tWHERE\r\n\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\tAND ([tPagAux].[tipo_parcelamento] <> 1)\r\n\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 2)\r\n\t) AS [QtdeParcelasFormaPagtoAPrazoOpcao2]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\tCASE\r\n\t\t\tWHEN (\r\n\t\t\tSELECT\r\n\t\t\t\tTOP 1 [tPagAux].[Id]\r\n\t\t\tFROM\r\n\t\t\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\t\t\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\t\t\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tAtomCustoFinAux] ON\r\n\t\t\t\t[tPagAux].[Id] = [tAtomCustoFinAux].[IdOpcaoPagto]\r\n\t\t\tWHERE\r\n\t\t\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\t\t\tAND ([tPagAux].[tipo_parcelamento] <> 1)\r\n\t\t\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 2)\r\n\t\t\t\t\t\t\t\tAND ([tAtomCustoFinAux].[StatusDescontoSuperior] <> 0)\r\n\t\t\t\t) IS NOT NULL THEN 'Sim'\r\n\t\t\tELSE 'Não'\r\n\t\tEND\r\n\t) AS [StatusDescSuperiorAPrazoOpcao2]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\t[tOpcAux].[PercRT]\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tWHERE\r\n\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\tAND ([tOpcAux].[Sequencia] = 3)\r\n\t) AS [ComissaoOpcao3]\r\n\t,\r\n\t(\r\n\tSELECT \r\n\t\t\tCASE\r\n\t\t\tWHEN (Coalesce(SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista]),\r\n\t\t\t0) <> 0) THEN\r\n\t\t\t\t(100 *((SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista]) - SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoNF])) / SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista])))\r\n\t\t\tELSE NULL\r\n\t\tEND\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_UNIFICADO] [tUnifAux] ON\r\n\t\t[tOpcAux].[Id] = [tUnifAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO] [tAtomAux] ON\r\n\t\t[tUnifAux].[Id] = [tAtomAux].[IdItemUnificado]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux] ON\r\n\t\t([tAtomAux].[Id] = [tCustoFinAux].[IdItemAtomico])\r\n\t\t\tAND ([tPagAux].[Id] = [tCustoFinAux].[IdOpcaoPagto])\r\n\t\tWHERE\r\n\t\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\t\tAND ([tPagAux].[tipo_parcelamento] = 1)\r\n\t\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 3)\r\n\t\t\t\t\t\t\tAND ([tPagAux].[Id] IN (\r\n\t\t\t\t\t\t\tSELECT\r\n\t\t\t\t\t\t\t\t[tCustoFinAux2].[IdOpcaoPagto]\r\n\t\t\t\t\t\t\tFROM\r\n\t\t\t\t\t\t\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux2]\r\n\t\t\t\t\t\t\tWHERE\r\n\t\t\t\t\t\t\t\t([tCustoFinAux2].[IdOpcaoPagto] = [tCustoFinAux].[IdOpcaoPagto])))\r\n\t) AS [DescMedioAVistaOpcao3]\r\n\t,\r\n\t(\r\n\tSELECT \r\n\t\t\tCASE\r\n\t\t\tWHEN (Coalesce(SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista]),\r\n\t\t\t0) <> 0) THEN\r\n\t\t\t\t(100 *((SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista]) - SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoNF])) / SUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoLista])))\r\n\t\t\tELSE NULL\r\n\t\tEND\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_UNIFICADO] [tUnifAux] ON\r\n\t\t[tOpcAux].[Id] = [tUnifAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO] [tAtomAux] ON\r\n\t\t[tUnifAux].[Id] = [tAtomAux].[IdItemUnificado]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux] ON\r\n\t\t([tAtomAux].[Id] = [tCustoFinAux].[IdItemAtomico])\r\n\t\t\tAND ([tPagAux].[Id] = [tCustoFinAux].[IdOpcaoPagto])\r\n\t\tWHERE\r\n\t\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\t\tAND ([tPagAux].[tipo_parcelamento] <> 1)\r\n\t\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 3)\r\n\t\t\t\t\t\t\tAND ([tPagAux].[Id] IN (\r\n\t\t\t\t\t\t\tSELECT\r\n\t\t\t\t\t\t\t\t[tCustoFinAux2].[IdOpcaoPagto]\r\n\t\t\t\t\t\t\tFROM\r\n\t\t\t\t\t\t\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux2]\r\n\t\t\t\t\t\t\tWHERE\r\n\t\t\t\t\t\t\t\t([tCustoFinAux2].[IdOpcaoPagto] = [tCustoFinAux].[IdOpcaoPagto])))\r\n\t) AS [DescMedioAPrazoOpcao3]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\t[tMeioPagAux].[Descricao]\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_CFG_PAGTO_MEIO] [tMeioPagAux] ON\r\n\t\t([tMeioPagAux].[Id] = [tPagAux].[av_forma_pagto])\r\n\tWHERE\r\n\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\tAND ([tPagAux].[tipo_parcelamento] = 1)\r\n\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 3)\r\n\t) AS [FormaPagtoAVistaOpcao3]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\tSUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoNF])\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_UNIFICADO] [tUnifAux] ON\r\n\t\t[tOpcAux].[Id] = [tUnifAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO] [tAtomAux] ON\r\n\t\t[tUnifAux].[Id] = [tAtomAux].[IdItemUnificado]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux] ON\r\n\t\t([tAtomAux].[Id] = [tCustoFinAux].[IdItemAtomico])\r\n\t\t\tAND ([tPagAux].[Id] = [tCustoFinAux].[IdOpcaoPagto])\r\n\t\tWHERE\r\n\t\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\t\tAND ([tPagAux].[tipo_parcelamento] = 1)\r\n\t\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 3)\r\n\t) AS [ValorFormaPagtoAVistaOpcao3]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\tCASE\r\n\t\t\tWHEN (\r\n\t\t\tSELECT\r\n\t\t\t\tTOP 1 [tPagAux].[Id]\r\n\t\t\tFROM\r\n\t\t\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\t\t\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\t\t\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tAtomCustoFinAux] ON\r\n\t\t\t\t[tPagAux].[Id] = [tAtomCustoFinAux].[IdOpcaoPagto]\r\n\t\t\tWHERE\r\n\t\t\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\t\t\tAND ([tPagAux].[tipo_parcelamento] = 1)\r\n\t\t\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 3)\r\n\t\t\t\t\t\t\t\tAND ([tAtomCustoFinAux].[StatusDescontoSuperior] <> 0)\r\n\t\t\t\t) IS NOT NULL THEN 'Sim'\r\n\t\t\tELSE 'Não'\r\n\t\tEND\r\n\t) AS [StatusDescSuperiorAVistaOpcao3]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\t[tFormaPagAux].[Descricao]\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_CFG_PAGTO_FORMA] [tFormaPagAux] ON\r\n\t\t([tPagAux].[tipo_parcelamento] = [tFormaPagAux].[Id])\r\n\tWHERE\r\n\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\tAND ([tPagAux].[tipo_parcelamento] <> 1)\r\n\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 3)\r\n\t) AS [FormaPagtoAPrazoOpcao3]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\tSUM([tUnifAux].[Qtde] * [tAtomAux].[Qtde] * [tCustoFinAux].[PrecoNF])\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_UNIFICADO] [tUnifAux] ON\r\n\t\t[tOpcAux].[Id] = [tUnifAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO] [tAtomAux] ON\r\n\t\t[tUnifAux].[Id] = [tAtomAux].[IdItemUnificado]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tCustoFinAux] ON\r\n\t\t([tAtomAux].[Id] = [tCustoFinAux].[IdItemAtomico])\r\n\t\t\tAND ([tPagAux].[Id] = [tCustoFinAux].[IdOpcaoPagto])\r\n\t\tWHERE\r\n\t\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\t\tAND ([tPagAux].[tipo_parcelamento] <> 1)\r\n\t\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 3)\r\n\t) AS [ValorFormaPagtoAPrazoOpcao3]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\tCASE\r\n\t\t\t[tPagAux].[tipo_parcelamento] WHEN 5 THEN 1\r\n\t\t\tWHEN 2 THEN [tPagAux].[pc_qtde_parcelas]\r\n\t\t\tWHEN 6 THEN [tPagAux].[pc_maquineta_qtde_parcelas]\r\n\t\t\tWHEN 3 THEN (1 + [tPagAux].[pce_prestacao_qtde])\r\n\t\t\tWHEN 4 THEN (1 + [tPagAux].[pse_demais_prest_qtde])\r\n\t\tEND\r\n\tFROM\r\n\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\tWHERE\r\n\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\tAND ([tPagAux].[tipo_parcelamento] <> 1)\r\n\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 3)\r\n\t) AS [QtdeParcelasFormaPagtoAPrazoOpcao3]\r\n\t,\r\n\t(\r\n\tSELECT\r\n\t\tCASE\r\n\t\t\tWHEN (\r\n\t\t\tSELECT\r\n\t\t\t\tTOP 1 [tPagAux].[Id]\r\n\t\t\tFROM\r\n\t\t\t\t[dbo].[t_ORCAMENTO_COTACAO_OPCAO] [tOpcAux]\r\n\t\t\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_PAGTO] [tPagAux] ON\r\n\t\t\t\t[tOpcAux].[Id] = [tPagAux].[IdOrcamentoCotacaoOpcao]\r\n\t\t\tINNER JOIN [dbo].[t_ORCAMENTO_COTACAO_OPCAO_ITEM_ATOMICO_CUSTO_FIN] [tAtomCustoFinAux] ON\r\n\t\t\t\t[tPagAux].[Id] = [tAtomCustoFinAux].[IdOpcaoPagto]\r\n\t\t\tWHERE\r\n\t\t\t\t([tOpcAux].[IdOrcamentoCotacao] = [tOC].[Id])\r\n\t\t\t\t\tAND ([tPagAux].[Habilitado] = 1)\r\n\t\t\t\t\t\tAND ([tPagAux].[tipo_parcelamento] <> 1)\r\n\t\t\t\t\t\t\tAND ([tOpcAux].[Sequencia] = 3)\r\n\t\t\t\t\t\t\t\tAND ([tAtomCustoFinAux].[StatusDescontoSuperior] <> 0)\r\n\t\t\t\t) IS NOT NULL THEN 'Sim'\r\n\t\t\tELSE 'Não'\r\n\t\tEND\r\n\t) AS [StatusDescSuperiorAPrazoOpcao3],";
