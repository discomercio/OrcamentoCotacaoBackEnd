...
Scenario: op_av_forma_pagto
	...
	Given Pedido base
	When Informo "forma_pagto" = "COD_FORMA_PAGTO_A_VISTA"
...
Scenario: c_pu_valor
	...
	Given Pedido base
	When Informo "forma_pagto" = "COD_FORMA_PAGTO_PARCELA_UNICA"
...
Scenario: c_pc_qtde
	...
	Given Pedido base
	When Informo "forma_pagto" = "COD_FORMA_PAGTO_PARCELADO_CARTAO"
...
Scenario: c_pc_maquineta_qtde
	...
	#		alert('Indique a quantidade de parcelas!!');
	Given Pedido base
	When Informo "forma_pagto" = "COD_FORMA_PAGTO_PARCELADO_CARTAO_MAQUINETA"
...
Scenario: op_pce_entrada_forma_pagto
	...
	Given Pedido base
	When Informo "forma_pagto" = "COD_FORMA_PAGTO_PARCELADO_COM_ENTRADA"
