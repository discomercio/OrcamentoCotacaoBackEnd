...
Scenario: t_WMS_REGRA_CD_X_UF - duplicado
	#Given No ambiente "Especificacao.Pedido.PedidoSteps" mapear erro "Falha na leitura da regra de consumo do estoque para a UF 'SP' e 'Pessoa Física': regra associada ao produto (003)003220 não foi localizada no banco de dados (Id=5)" para ""
