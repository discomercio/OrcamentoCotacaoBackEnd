...
namespace Especificacao.Especificacao.Pedido.Passo60.Gravacao.Passo20.ObtemCtrlEstoqueProdutoRegra
{
    ...
    public partial class T_PRODUTO_X_WMS_REGRA_CDFeature : object, Xunit.IClassFixture<T_PRODUTO_X_WMS_REGRA_CDFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "t_PRODUTO_X_WMS_REGRA_CD.feature"
#line hidden
        
        public T_PRODUTO_X_WMS_REGRA_CDFeature(T_PRODUTO_X_WMS_REGRA_CDFeature.FixtureData fixtureData, Especificacao_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "t_PRODUTO_X_WMS_REGRA_CD", null, ProgrammingLanguage.CSharp, new string[] {
                        "Especificacao.Pedido.Passo60",
                        "GerenciamentoBanco"});
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="t_PRODUTO_X_WMS_REGRA_CD - id_wms_regra_cd = 0")]
        [Xunit.TraitAttribute("FeatureTitle", "t_PRODUTO_X_WMS_REGRA_CD")]
        [Xunit.TraitAttribute("Description", "t_PRODUTO_X_WMS_REGRA_CD - id_wms_regra_cd = 0")]
        public virtual void T_PRODUTO_X_WMS_REGRA_CD_Id_Wms_Regra_Cd0()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("t_PRODUTO_X_WMS_REGRA_CD - id_wms_regra_cd = 0", null, tagsOfScenario, argumentsOfScenario);
#line 14
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="t_PRODUTO_X_WMS_REGRA_CD - sem regra")]
        [Xunit.TraitAttribute("FeatureTitle", "t_PRODUTO_X_WMS_REGRA_CD")]
        [Xunit.TraitAttribute("Description", "t_PRODUTO_X_WMS_REGRA_CD - sem regra")]
        public virtual void T_PRODUTO_X_WMS_REGRA_CD_SemRegra()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                T_PRODUTO_X_WMS_REGRA_CDFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                T_PRODUTO_X_WMS_REGRA_CDFeature.FeatureTearDown();
            }
        }
    }
}
