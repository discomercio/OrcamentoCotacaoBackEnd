...
Scenario: obtemCtrlEstoqueProdutoRegra - t_WMS_REGRA_CD_X_UF_X_PESSOA duplicado
	Given Tabela t_WMS_REGRA_CD_X_UF_X_PESSOA duplicar registro id_wms_regra_cd_x_uf = "134" e tipo de pessoa = "PF" com id = "811"
	Given Tabela t_WMS_REGRA_CD_X_UF_X_PESSOA duplicar registro id_wms_regra_cd_x_uf = "134" e tipo de pessoa = "PR" com id = "812"
	Given Pedido base
	Then Erro "Falha na leitura da regra de consumo do estoque para a UF 'SP' e 'Pessoa Física': regra associada ao produto (003)003220 não está cadastrada para a UF 'SP' (Id=5)"