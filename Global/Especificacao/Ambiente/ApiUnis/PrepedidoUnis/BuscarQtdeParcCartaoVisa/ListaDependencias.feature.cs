...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 5
 testRunner.Given("Nome deste item \"Ambiente.ApiUnis.PrepedidoUnis.BuscarQtdeParcCartaoVisa.ListaDep" +
                        "endencias\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 7
