...
Scenario: COD_FORMA_PAGTO_PARCELADO_CARTAO - verifica campos na tabela t_PEDIDO
	...
	And Tabela "t_PEDIDO" registro criado, verificar campo "vl_total_familia" = "3440.00"
	And Tabela "t_PEDIDO" registro criado, verificar campo "vl_total_RA" = "0"
	#os valores dos produtos são diferentes pqoeu no magento eles são redistribuídos
	And Tabela "t_PEDIDO_ITEM" registro criado, verificar item "1" campo "qtde" = "2"
	And Tabela "t_PEDIDO_ITEM" registro criado, verificar item "1" campo "preco_venda" = "516.01"
	And Tabela "t_PEDIDO_ITEM" registro criado, verificar item "1" campo "preco_NF" = "516.01"
	And Tabela "t_PEDIDO_ITEM" registro criado, verificar item "2" campo "qtde" = "2"
	And Tabela "t_PEDIDO_ITEM" registro criado, verificar item "2" campo "preco_venda" = "1203.99"
	And Tabela "t_PEDIDO_ITEM" registro criado, verificar item "2" campo "preco_NF" = "1203.99"
...
Scenario: COD_FORMA_PAGTO_PARCELADO_CARTAO - manter o mesmo valor
	...
	When Informo "FormaPagtoCriacao.C_pc_qtde" = "1"
	When Informo "FormaPagtoCriacao.C_pc_valor" = "3450.00"
	When Informo "Frete" = "0"
	When Lista de itens "0" informo "Produto" = "001000"
	When Lista de itens "0" informo "Qtde" = "2"
	When Lista de itens "0" informo "Preco_Venda" = "509.24"
	...
	And Tabela "t_PEDIDO" registro criado, verificar campo "tipo_parcelamento" = "2"
	And Tabela "t_PEDIDO" registro criado, verificar campo "pc_qtde_parcelas" = "1"
	And Tabela "t_PEDIDO" registro criado, verificar campo "pc_valor_parcela" = "3450.00"
	And Tabela "t_PEDIDO" registro criado, verificar campo "vl_total_NF" = "3450.00"
	And Tabela "t_PEDIDO" registro criado, verificar campo "vl_total_familia" = "3450.00"
	And Tabela "t_PEDIDO" registro criado, verificar campo "vl_total_RA" = "0"
	And Tabela "t_PEDIDO_ITEM" registro criado, verificar item "1" campo "qtde" = "2"
